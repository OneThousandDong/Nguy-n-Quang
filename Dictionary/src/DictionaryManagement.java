...
public class DictionaryManagement {
        ...
        public void dictionaryExportToFile(Map<String,String>map)
        {
                ...
                File file = new File("C:\\Users\\Admin\\IdeaProjects\\Dictionary\\1.txt");
                FileWriter fr = null;
        ...
        public void dictionaryExportToFile(String s)
        {
                ...
                File file = new File("C:\\Users\\Admin\\IdeaProjects\\Dictionary\\2.txt");
                FileWriter fr = null;
                BufferedWriter br = null;
                try{
                        if (!file.exists()) {
        ...
        {
                try {
                        File file = new File("C:\\Users\\Admin\\IdeaProjects\\Dictionary\\dictionaries.txt");
                        if (!file.exists()) {
                                file.createNewFile();
                        }
